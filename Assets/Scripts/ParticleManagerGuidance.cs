...
public class ParticleManagerGuidance : MonoBehaviour
{
 
    VisualEffect visualEffect;
    Guidance shoulderData;
    ...
    public bool leftGatheringStart = true;
    public bool leftSpreadingStart = false;
    bool leftRelaxingStart = false;
    public bool rightGatheringStart = true;
    ...
    void Start()
    {
        ...
        shoulderData = gameObject.GetComponent<Guidance>();
        ...
        setTensionThresholdL = shoulderData.tensionThresholdL;
        setTensionThresholdR = shoulderData.tensionThresholdR;
        setRelaxationThresholdL = shoulderData.relaxationThresholdL;
        setRelaxationThresholdR = shoulderData.relaxationThresholdR;
    ...
    void FixedUpdate()
    {
        float shoulderLeft;
        float shoulderRight;
        shoulderLeft = shoulderData.shoulderL;
        shoulderRight = shoulderData.shoulderR;
